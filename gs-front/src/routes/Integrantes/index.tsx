...
const integrantes = [
  {
    ...
    title: "Mergulhador de Superfície",
    delay: "0s",
  },
  {
    ...
    depth: "28%",
    align: "justify-start md:pl-[15%]",
    title: "Explorador Crepuscular",
    delay: "1s",
  },
  {
    ...
    depth: "50%",
    align: "justify-end md:pr-[15%]",
    title: "Navegador da Meia-Noite",
    delay: "2s",
  },
  {
    ...
    <div className="h-[500vh] relative w-full">
      ...
      <div className="absolute top-0 w-full flex flex-col items-center pt-24 px-4 text-center">
        ...
        <p className="text-blue-100 text-lg md:text-xl max-w-2xl font-medium drop-shadow-md">
          Coloque seu escafandro e mergulhe para conhecer a equipe responsável
          por esta exploração.
        </p>
          ...
          >
            ...
            <div className="flex gap-5 mt-auto">
              <a
                ...
                className="hover:-translate-y-1 transition-transform bg-[#1e272e] p-3 rounded-full border border-gray-600 hover:border-blue-400 hover:shadow-[0_0_10px_rgba(96,165,250,0.5)]"
              >
