          ...
          <div className="max-w-2xl bg-surface-0 backdrop-blur-md p-10 rounded-2xl border border-surface-1 pointer-events-auto">
            ...
            <div className="space-y-4 text-text/80 font-light leading-relaxed">
              <p>
                ...
                inovadoras para mapear os lixos marinhos, monitorar a vida
                aquática e preservar os ecossistemas subaquáticos. Acreditamos
                que a tecnologia pode ser uma ferramenta poderosa para entender
                e proteger nosso planeta azul.
              </p>
              <p>
                Fundado por um grupo de entusiastas do oceano e tecnologia, o
                Thalassor nasceu da paixão por desvendar os mistérios do mar e
                contribuir para a conservação marinha. Com uma equipe
                multidisciplinar, combinamos habilidades em desenvolvimento de
                software, ciência de dados e biologia marinha para criar
                soluções que fazem a diferença.
              </p>
              <p>
                Junte-se a nós nessa jornada para explorar as profundezas do
                oceano e criar um futuro mais sustentável para nossos mares. O
                Thalassor é mais do que um grupo de software - somos uma
                comunidade de exploradores digitais dedicados a proteger o
